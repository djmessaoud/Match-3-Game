...
public class GameControllerScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _volumeSlider.value = _musicSource.volume = _soundSource.volume = _winSoundSource.volume = _loseSoundSource.volume = volume;
   ...
   public void changeVolume()
    {
        ...
        _musicSource.volume = _soundSource.volume = _winSoundSource.volume = _loseSoundSource.volume = _volumeSlider.value;
    }  
    public void muteVolume()
    {
        PlayerPrefs.SetFloat("volume", 0);
        _musicSource.volume = _soundSource.volume = _volumeSlider.value= _winSoundSource.volume = _loseSoundSource.volume = 0;
    } 
    public void unmuteVolume()
    {
        PlayerPrefs.SetFloat("volume",1f);
        _musicSource.volume = _soundSource.volume = _volumeSlider.value = _winSoundSource.volume = _loseSoundSource.volume = 1;
    }
